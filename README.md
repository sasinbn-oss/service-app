...
ไฟล์ export ไม่มีสามค่านี้ ตัวนำเข้าจึง**ไม่แตะค่าเดิม** รอ query จากฐานข้อมูลที่ทำแยก
ระหว่างนี้แดชบอร์ดจัดกลุ่มตาม **เจ้าของ (COCO/DODO)** ได้ และสลับเป็นภาค/โซนได้ทันทีเมื่อมีข้อมูล
ถ้าวันหลังใส่คอลัมน์ `region` `zone` `grade` มาในไฟล์ ระบบจะหยิบไปใช้เองโดยไม่ต้องแก้อะไร
