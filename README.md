...
หน้าหลักแบ่งเป็นแท็บที่มุมบนซ้าย:

| แท็บ | เนื้อหา | ใครเห็น |
|---|---|---|
| **งานช่าง** | 6 ฟีเจอร์ที่ใช้หน้างาน — วินิจฉัย, อะไหล่, รายงานตัว, บันทึกงาน, ใช้รถ, เบิกของ | ทุกคน |
| **ประวัติ** | ประวัติย้อนหลังทุกประเภทรวมไว้ที่เดียว + คู่มือแบบข้อความ | ทุกคน |
| **หลังบ้าน** | เมนูจัดการข้อมูลทั้งหมด และคิวอนุมัติคำขอเบิก | เฉพาะแอดมิน |

แท็บหลังบ้านจะไม่แสดงให้ช่างเห็นเลย และมีจุดแดงบอกจำนวนคำขอที่รออนุมัติ
