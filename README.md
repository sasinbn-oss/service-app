...
7. **ผู้ช่วย AI** — ถามข้อมูลในระบบ หรือให้ช่วยออกเอกสาร: เอกสารขอโอนสินค้าระหว่างคลังออกเป็นไฟล์ Word ตามแบบฟอร์มบริษัทได้เลย ส่วนรายงานสรุปงาน ใบรายงานการซ่อม สรุปการเบิกของ ร่างจากข้อมูลจริงที่บันทึกไว้
...
พิมพ์คลังต้นทาง คลังปลายทาง และรายการของ แล้วผู้ช่วยจะสร้างไฟล์ `.docx`
ตามแบบฟอร์มบริษัทให้ พร้อมปุ่มดาวน์โหลดใต้ข้อความ เช่น

```
ขอเอกสารโอนอะไหล่ จากคลังลาดพร้าว 94 ไปคลังเชียงใหม่
SEOTO83 - คอยล์มิเตอร์ตัวรับเหรียญ 3 ตัว
SPHB416 - ELECTRODE, SPARK PKG 3 ตัว
```

- **ผู้จัดทำ** เติมจากชื่อผู้ที่ล็อกอินอยู่ ไม่ได้ให้ AI กรอกเอง
- **วันที่เอกสาร** เป็นวันที่วันนี้แบบ พ.ศ. (เช่น 6 สิงหาคม 2569) ถ้าไม่ได้ระบุ
- รหัสอะไหล่จะถูกเทียบกับฐานข้อมูล ถ้าเจอจะใช้ชื่อทางการจากระบบแทนที่พิมพ์มา
  ถ้ารหัสไหนไม่มีในระบบ ผู้ช่วยจะออกเอกสารให้แต่เตือนไว้ให้ตรวจก่อนส่งอนุมัติ
- **เลขที่เอกสาร** เว้นว่างไว้ให้กรอกเอง เพราะระบบไม่รู้เลขที่รันของบริษัท
  ถ้าอยากให้ใส่ ก็พิมพ์บอกไปได้เลย
- ลิงก์ดาวน์โหลดมีอายุ **2 ชั่วโมง** ส่งต่อให้คนอนุมัติได้ในช่วงนั้น หมดอายุแล้วสั่งสร้างใหม่
...
- `GET /api/assistant/documents/:id?token=` — ดาวน์โหลดไฟล์ที่ผู้ช่วยสร้าง
