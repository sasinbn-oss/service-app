...
7. **ติดตามเครื่องเสีย** — อัปโหลดไฟล์รายงานวันละ 2 ครั้ง แยกเครื่องดับกับสาขาสัญญาณหาย พร้อมนับเวลา SLA ให้อัตโนมัติ
...
**เครื่องซัก/อบ**
- `GET /api/machines/outages?ownership=&grade=&region=&zone=&search=&breachedOnly=` — เครื่องดับ รายเครื่อง
